...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/great-expectations-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/great-expectations-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add great-expectations
# for installing globally
pixi global install great-expectations
```
...
It is possible to list all of the versions of `great-expectations` available on your platform:
...
```
pixi search great-expectations --channel conda-forge
```
